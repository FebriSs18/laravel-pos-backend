...
@push('scripts')
    <!-- JS Libraies -->
    {{-- <script src="cleave.js"></script> <script src="cleave-phone.i18n.js"></script> <script src="jquery-3.6.0.js"></script> <script> document.addEventListener('DOMContentLoaded', () => { const cleave = new Cleave('#phnnumIput', { phone: true, phoneRegionCode: 'US' }); }); </script> --}}
